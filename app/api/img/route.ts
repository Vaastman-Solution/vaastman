...
const MAX_FILE_SIZE = 9 * 1024 * 1024 // 9MB for original upload
...
export async function POST(request: Request) {
	try {
		...
		console.log(`Optimized (local) size: ${(optimizedBuffer.length / 1024).toFixed(2)}KB`)
		...
		console.log(`Final Cloudinary size: ${((result as any).bytes / 1024).toFixed(2)}KB`)
